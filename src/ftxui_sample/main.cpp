...
// configuration step. It creates a namespace called `VulkanCm`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", VulkanCm::cmake::project_name, VulkanCm::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", VulkanCm::cmake::project_version);
      return EXIT_SUCCESS;
    }
